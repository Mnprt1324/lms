      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-[65%]">
          ...
          <div className="shadow rounded-lg px-4 py-4 ml-3">
            ...
            {/* Comment List */}
            <div className="space-y-3 overflow-x-hidden h-52 overflow-y-auto">
              {Array.isArray(currentLecture?.comments) &&
                  ...
                  <div key={c._id} className="border-b pb-3">
                    <div className="flex items-center gap-3">
                      <Avatar className="w-9 h-9">
                        <AvatarImage
                          src={
                            c.userId?.avatar || "https://github.com/shadcn.png"
                          }
                        />
                        <AvatarFallback>
        ...
        <div className="w-full lg:w-[35%] border rounded-lg p-4">
          <div className="flex items-center justify-between mb-5">
            <h2 className="text-lg font-bold">All Lectures</h2>
            <Button
              variant={isComplete ? "outline" : ""}
              onClick={handleToggleMark}
              disabled={courseDetails?.lectures?.length === 0}
            >
